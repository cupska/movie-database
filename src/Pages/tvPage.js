...
export function TvPage(props) {
    ...
    const url = `https://api.themoviedb.org/3/discover/tv?api_key=e92a7d5bfbd2499a7104d19001e21114&language=en-US&sort_by=${sortBy}&include_video=false&page=${page}`
    useEffect(() => {
        fetch(url)
        .then(res => res.json())
        ...
        <div className=" w-[100%]">
            ...
            <div className=" m-auto w-fit flex flex-col gap-8 my-10">
                <div className=" flex justify-center">
                    <h1 className=" title-slider">Discover TV</h1>
                </div>
